      ...
      <div className="max-w-[1800px] w-full mx-auto relative z-10">
        ...
        >
            <div className="flex flex-col items-start">
                ...
                <div className="flex items-center gap-1 text-text-primary text-text-primary">
                  <Brain size={16} className="text-accent" />
                  <span className="font-mono text-xs font-bold tracking-widest uppercase text-center">Deep Learning Model Visualization</span>
                </div>
            </div>

            {/* Stats (Positioned Absolute Right) */}
            <div className="hidden md:flex gap-6 absolute right-0 bottom-2">
                ...
                <div className="text-right pl-6 border-l border-accent/20">
                    <div className="text-xs text-text-primary uppercase tracking-wider font-mono">Status</div>
                    <div className="flex items-center justify-end gap-2 text-xl font-mono text-[#4dfffe]">
